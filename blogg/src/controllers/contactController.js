function showContactPage(req, res){
    const contactText =`Proin bibendum efficitur pharetra. Integer enim enim, pellentesque id imperdiet sed,
    ...
    res.render("contact.ejs", {contactText: contactText});
}

module.exports = showContactPage;